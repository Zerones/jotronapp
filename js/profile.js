...
function profileEdit() 
{
        ...
        lagrefil += `<div class="profilePass1" style="border:none">Password: <input type="password" name="password" id="passwordValue"></div>
                                     <div class="profilePass2" style="border:none">Password again: <input type="password" name="password" id="passwordValueConfirm"></div>`;
        lagrefil += `<button type="button" class="profile7" onclick="saveProfile(this)" onmouseout="hoverman(this)">Save Edits</button>`;
        lagrefil += '</div>';
